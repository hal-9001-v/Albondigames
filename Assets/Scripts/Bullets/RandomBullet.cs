...
public class RandomBullet : EnemyBullet
{
   public override void virtualStart()
    ...
    public virtual void OnTriggerEnter2D(Collider2D hitInfo)
    {
        if (!hitInfo.gameObject.tag.Equals("Enemy") && !hitInfo.gameObject.tag.Equals("AuxCollider"))
        {
            ...
            if (!hitInfo.gameObject.tag.Equals("Enemy") && !hitInfo.gameObject.tag.Equals("Bullet") && !hitInfo.gameObject.tag.Equals("Muebles") && !hitInfo.gameObject.tag.Equals("Item") && !hitInfo.gameObject.tag.Equals("zone")) Destroy(this.gameObject);
